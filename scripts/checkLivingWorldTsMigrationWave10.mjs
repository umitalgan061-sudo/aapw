...
const modules=['livingWorldOccupationSchedule','livingWorldRuntimeEvidence'];
...
console.log(JSON.stringify({ok:true,migratedModules:modules.length,domain:'living-world-schedule-and-evidence'}));
