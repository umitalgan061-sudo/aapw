...
assert.equal(computeEditorAssetImportScale({ id: 'castle-small', format: 'glb', targetMaxDimension: 46 }, 10), 4.6);
assert.equal(computeEditorAssetImportScale({ id: 'castle-large', format: 'glb', targetMaxDimension: 46 }, 100), 0.46);
assert.equal(computeEditorAssetImportScale({ id: 'invalid-target', format: 'glb', targetMaxDimension: 0 }, 10), 1);
