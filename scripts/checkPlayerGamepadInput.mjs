...
for (const contract of ["JUMP: 0", "LIGHT: 2", "HEAVY: 3", "GUARD: 4", "ZOOM_OUT: 6", "ZOOM_IN: 7", "SPRINT: 10", "gamepad.axes?.[2]", "gamepad.axes?.[3]", "pad.mapping === 'standard'", "pulsePlayerGamepadMelee", "dual-rumble"]) assert.ok(source.includes(contract), `missing ${contract}`);
