...
const MIGRATIONS = [
  { legacy: 'src/3d/auroraRealism.js', modern: 'src/3d/auroraRealism.js' },
  { legacy: 'src/3d/gameplay/animalConfig.js', modern: 'src/3d/gameplay/animalConfig.js' },
  { legacy: 'src/3d/gameplay/interactionFieldReadiness.js', modern: 'src/3d/gameplay/interactionFieldReadiness.js' },
  { legacy: 'src/3d/gameplay/livingWorldStimulusAdapter.js', modern: 'src/3d/gameplay/livingWorldStimulusAdapter.js' },
  { legacy: 'src/3d/gameplay/livingWorldStimulusAudit.js', modern: 'src/3d/gameplay/livingWorldStimulusAudit.js' },
  { legacy: 'src/3d/gameplay/livingWorldStimulusRolePolicy.js', modern: 'src/3d/gameplay/livingWorldStimulusRolePolicy.js' },
  { legacy: 'src/3d/gameplay/settlementCampaignSaveSlots.js', modern: 'src/3d/gameplay/settlementCampaignSaveSlots.js' },
  { legacy: 'src/3d/gameplay/settlementCampaignTelemetry.js', modern: 'src/3d/gameplay/settlementCampaignTelemetry.js' },
  { legacy: 'src/3d/gameplay/worldOpportunityEvidence.js', modern: 'src/3d/gameplay/worldOpportunityEvidence.js' },
  { legacy: 'src/3d/gameplay/worldShelterContext.js', modern: 'src/3d/gameplay/worldShelterContext.js' },
  { legacy: 'src/3d/gameplay/livingWorldEcologyPolicy.js', modern: 'src/3d/gameplay/livingWorldEcologyPolicy.js' },
  { legacy: 'src/3d/gameplay/livingWorldEventDirectorAdapter.js', modern: 'src/3d/gameplay/livingWorldEventDirectorAdapter.js' },
  { legacy: 'src/3d/gameplay/livingWorldFaunaActivityBudget.js', modern: 'src/3d/gameplay/livingWorldFaunaActivityBudget.js' },
  { legacy: 'src/3d/gameplay/livingWorldFaunaHabitatBalancer.js', modern: 'src/3d/gameplay/livingWorldFaunaHabitatBalancer.js' },
  { legacy: 'src/3d/gameplay/livingWorldFaunaSignalRouter.js', modern: 'src/3d/gameplay/livingWorldFaunaSignalRouter.js' },
  { legacy: 'src/3d/gameplay/livingWorldGroupAiPolicy.js', modern: 'src/3d/gameplay/livingWorldGroupAiPolicy.js' },
  { legacy: 'src/3d/gameplay/livingWorldGroupDirectorAdapter.js', modern: 'src/3d/gameplay/livingWorldGroupDirectorAdapter.js' },
];
