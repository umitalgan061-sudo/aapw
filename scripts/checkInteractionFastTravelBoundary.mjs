...
const unpreparedMissingDestination = evaluateFastTravelRequest({}, {
	destinationId: '',
	discovered: false,
});
assert.deepEqual(unpreparedMissingDestination.reasons, [
	FAST_TRAVEL_BLOCK_REASON.NO_DESTINATION,
	FAST_TRAVEL_BLOCK_REASON.FIELD_KIT_REQUIRED,
]);
