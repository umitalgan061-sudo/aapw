...
module.exports = {
	...
	checkNpcPatrol,
	checkWolfPatrol,
	// Backward-compatible aliases: dragon checks moved to their own file in run 60 to keep this
	// module under the 600-line cap, but existing script consumers can still import them here.
	checkDragonFlight: dragonChecks.checkDragonFlight,
	checkDragonNotice: dragonChecks.checkDragonNotice,
	checkDragonReactiveFlight: dragonChecks.checkDragonReactiveFlight,
	checkDragonSwoopFlight: dragonChecks.checkDragonSwoopFlight,
};
