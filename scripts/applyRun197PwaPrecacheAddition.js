...
const ENTRY = "GAME3D_SHELL_FILES.push('./src/3d/world/worldReferenceCurrentTickOwnershipShadow.js');";
...
console.log('[applyRun197PwaPrecacheAddition] PASS: current-tick ownership shadow module is included in GAME3D_SHELL_FILES with one additive line.');
