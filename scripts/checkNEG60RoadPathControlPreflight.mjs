...
const metrics={samples,guardSamples,maxCoverage,maxNeighborCoverageStep,maxHeightDelta,maxControlDelta,maxMaterialDelta,guardMaxCoverage,guardMaxHeightError,checksum:checksum>>>0};
