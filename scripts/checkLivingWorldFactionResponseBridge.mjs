...
assert.equal(a.counts.observations, 3);
...
assert.equal(applied.delegated, 3);
assert.equal(applied.emitted, 2);
assert.deepEqual(calls, ['decision:assist', 'decision:engage', 'decision:pursue', 'event:engage', 'event:pursue']);
