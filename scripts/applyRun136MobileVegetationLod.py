#!/usr/bin/env python3
"""Apply Run 136 mobile vegetation geometry LOD as additive-only changes."""
...
Path("scripts/captureRun136MobileVegetationEvidence.js").write_text(r'''#!/usr/bin/env node
...
print("Run 136 additive mobile vegetation LOD changes staged.")
