...
material.dispose();
console.log('[checkTerrainAperiodicSurface] PASS: shipped ChunkManager terrain receives render-only multi-scale world-space breakup without changing geometry/collider authority.');
