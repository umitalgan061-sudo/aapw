...
material.dispose();
console.log('[checkTerrainAperiodicSurface] PASS: shipped fog bootstrap applies render-only multi-scale albedo/roughness and Three.js-compatible aperiodic micro-normal contrast without adding an uncached PWA module or changing geometry/collider authority.');
