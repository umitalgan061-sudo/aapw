...
const manifest = { schema:'se-g77-rock-snow-evidence-r10', sourceMapSha256:probe.sourceMapSha256, sourceMapSize:probe.sourceMapSize, sourceMapVersion:probe.sourceMapVersion, geoCell:'G77', layer:'Rock/Snow', terrain3dImportSize:257, evidence };
