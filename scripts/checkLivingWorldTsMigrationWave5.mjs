...
const modules=[
  'livingWorldStimulusAdapter',
  'livingWorldStimulusRolePolicy',
  'worldShelterContext',
  'livingWorldStimulusAudit',
  'settlementCampaignTelemetry',
  'settlementCampaignSaveSlots',
  'worldOpportunityEvidence',
];
...
console.log(JSON.stringify({ok:true,migratedModules:modules.length,domain:'living-world-and-settlement-support'}));
