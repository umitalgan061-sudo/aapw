...
append('3D_GAME_PROGRESS.md', [
	...
	'- Session/concurrency: main was re-read at Run191 merge `8626dd0`; GOVERNANCE, Run191 progress/ADR and owner-resolution context were checked before starting. No competing open PR existed at start. Owner-pending items unrelated to this scope were not guessed.',
	...
	'- DoD: node --check, additive-only, canonical map/hydrology/migration/terrain/chunk/road/Run191 bridge gates, determinism/assets/PWA/cache, a11y/input/physics, mobile streaming/radius4/LOD/culling/perf and baseline+after browser smoke ' + process.env.RUN192_SMOKE_PASS_COUNT + '/34+ PASS; zero 3D console/page errors.',
