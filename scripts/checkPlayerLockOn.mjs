...
const candidates = [entity('near-edge', 8, 8), entity('center-farther', 0, 12), entity('behind', 0, -4)]; assert.equal(selectPlayerLockTarget({ playerPosition: player, forward, candidates }).id, 'center-farther');
