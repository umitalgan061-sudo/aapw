...
if (!(probe.worldWidthMeters > 13000 && probe.worldDepthMeters > 10000)) throw new Error(`G75 physical normal scale is not the canonical full-reference extent: ${probe.worldWidthMeters}x${probe.worldDepthMeters}`);
...
const metrics = Object.freeze({
  ...
  worldWidthMeters: probe.worldWidthMeters,
  worldDepthMeters: probe.worldDepthMeters,
