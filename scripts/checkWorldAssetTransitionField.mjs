...
assert.ok(coast.coast.inner > 0.65, 'coastal inner band should be strong at 8m');
assert.ok(coast.coast.total > 0.95, 'coast total should cover the full transition envelope');
...
assert.ok(river.river.inner > 0.70, 'river inner band should be strong at 4m');
...
assert.ok(settlement.settlement.inner > 0.75, 'settlement inner band should be strong at 5m');
assert.ok(settlement.road.inner > 0.75, 'road inner band should be strong at 3m');
