...
fs.writeFileSync(
  ...
  `${JSON.stringify({ schema: 'westeros-g17-road-path-source-evidence-v2', sourceMapSha256: G17_ROAD_PATH_POLICY.sourceMapSha256, sourceMapVersion: G17_ROAD_PATH_POLICY.sourceMapVersion, sourceMapSize: G17_ROAD_PATH_POLICY.sourceMapSize, coverage, routeEvidence }, null, 2)}\n`,
);
