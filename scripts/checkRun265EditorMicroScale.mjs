...
if (module.EDITOR_MICRO_SCALE_POLICY.decimals !== 6) throw new Error('micro policy decimals must remain six');
...
micro.dispose();
legacy.dispose();
console.log('PASS Run265 editor micro-scale: Inspector + quick shrink + TransformControls display + scene JSON preserve 0.000001 exactly.');
