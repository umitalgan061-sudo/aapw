...
// Continues the Run277-293 reverse-prepend offline / chronological-boot convention.
...
console.log('[checkRun294Pindex07DetailChain] PASS: chronological runtime + reverse-prepend offline Pindex-01→07 contracts locked');
