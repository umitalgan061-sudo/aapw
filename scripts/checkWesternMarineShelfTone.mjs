...
assert.equal(P.id, 'western-marine-shelf-tone-2026-08-27-v10-mudflow-shell-pavement');
...
assert(P.mudflowVariation > 0.03 && P.mudflowVariation < 0.08);
assert(P.shellPavementVariation > 0.03 && P.shellPavementVariation < 0.08);
...
assert(westernColorDelta > 0.004, `v10 shelf material collapsed toward a uniform tint: delta=${westernColorDelta}`);
