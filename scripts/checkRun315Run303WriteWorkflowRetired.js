...
const fail = (message) => { throw new Error(`[checkRun315Run303WriteWorkflowRetired] ${message}`); };
...
console.log(`[checkRun315Run303WriteWorkflowRetired] PASS: ${OLD_NAME} retired; no dispatch+write or hard-push owner remains for ${HISTORICAL_BRANCH}; ${READ_ONLY_NAME} remains a contents:read negative control`);
