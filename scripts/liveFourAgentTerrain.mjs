...
import { sampleG65NearDetail } from '../godot/terrain-authoring/geocells/se/g65_near_detail.mjs';
...
export const LIVE_FOUR_AGENT_TERRAIN_POLICY = Object.freeze({
  id: 'live-four-agent-owner-map-terrain-2026-08-13-v2',
...
const CELLS = Object.freeze([
  ...
  Object.freeze({ id: 'G65', agent: 'Kızıl Ufuk', layer: 'Near Detail', x0: 6 / 8, x1: 7 / 8, y0: 5 / 8, y1: 6 / 8, sample: (x, y) => sampleG65NearDetail(x, y).authoredHeight }),
...
const GAME_INSTALL = Symbol.for('westeros.live-four-agent-terrain.game.v2');
