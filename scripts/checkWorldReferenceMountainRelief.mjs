...
assert(actual.heightChecksumSha256 === fixture.heightChecksumSha256, `height checksum drift: ${actual.heightChecksumSha256}; metrics: ${JSON.stringify(actual.metrics)}`);
