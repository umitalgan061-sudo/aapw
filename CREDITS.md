...
| `owner_model_meshy_ai_character_output_cdfd2b17403fde70` | `assets/models/fbx/Meshy_AI_Character_output.glb` | Meshy AI (filename attribution; account/license tier unverified) | UNKNOWN — owner-approved for runtime use (§33.3) |
| `owner_model_meshy_ai_create_an_ultra_detai_0819104851_te_5a4b5cef095a7854` | `assets/models/fbx/Meshy_AI_Create_an_ultra_detai_0819104851_texture.glb` | Meshy AI (filename attribution; account/license tier unverified) | UNKNOWN — owner-approved for runtime use (§33.3) |
...
| `owner_model_meshy_ai_march_of_the_wooden_l_0819083039_te_2247743cf66b4287` | `assets/models/fbx/Meshy_AI_March_of_the_Wooden_L_0819083039_texture.glb` | Meshy AI (filename attribution; account/license tier unverified) | UNKNOWN — owner-approved for runtime use (§33.3) |
