...
export const PINDEX05_DETAIL_POLICY = Object.freeze({
  id: 'owner-map-pindex05-detail-candidate-2026-08-11-v3',
  pindex: 5,
...
export function applyPindex05DetailToTerrainMesh(mesh) {
  ...
  mesh.userData.run288Pindex05Candidate = summary;
  return summary;
}
...
export function applyPindex05DetailToTerrainGroup(terrainGroup) {
  ...
  terrainGroup.userData.run288Pindex05Candidate = summary;
  return summary;
}
