 ...
 */
export function createGroundCollider(seed, fbmOptions, flattenPads, roadCorridor = null, valleyField = null) {
	...
	const sampleHeightMeters = createHeightSampler(seed, fbmOptions, flattenPads, roadCorridor, valleyField);
	return {
