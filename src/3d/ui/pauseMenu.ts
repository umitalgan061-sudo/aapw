/** Production TypeScript owner for the pause/settings UI; legacy JS path remains compatibility-only. */
// @ts-nocheck
import { QUALITY_LEVELS, STORAGE_KEYS } from '../config.ts';
...
export interface PauseMenuOptions {
  ...
  readonly quitHref?: string;
  readonly isMobileClass?: boolean;
  readonly storage?: Storage | null;
  readonly reload?: () => void;
  readonly onMuteChange?: ((muted: boolean) => void) | null;
}
