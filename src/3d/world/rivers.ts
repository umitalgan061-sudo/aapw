/** Production TypeScript owner for src/3d/world/rivers.js. Legacy .js remains compatibility-only. */
// @ts-nocheck
/**
...
/** Typed river point contract for hydrology/path consumers. */
export interface RiverPoint {
  readonly x: number;
  readonly y: number;
  readonly z: number;
}
export interface RiverPathOptions {
