/** Production TypeScript owner for src/3d/world/geographicAssetContext.js. Legacy .js remains compatibility-only. */
// @ts-nocheck
/*
...
export interface GeographicAssetContextContract {
  readonly regionId?: string;
  readonly surface?: Readonly<Record<string, unknown>>;
  readonly climate?: Readonly<Record<string, unknown>>;
}
