...
export const TERRAIN_SNOW_SURFACE_TONE_POLICY = Object.freeze({
  id: 'terrain-snow-surface-tone-2026-08-28-v27-firn-crust-powder-separation',
  renderOnly: true,
  ...
  packedWindwardGain: 0.82,
  packedRidgeGain: 0.44,
  packedPermanentIceFloor: 0.16,
  packedGlacialContinuityGain: 0.10,
  packedGlacialFamilyGain: 0.19,
  packedGlacialDepthGain: 0.10,
  packedShelteredGlacialGain: 0.10,
  packedTransitionColdGain: 0.085,
  mixedIceFirnPackedFloorGain: 0.34,
  mixedIceFirnPowderAttenuation: 0.38,
  coreIceFirnPackedFloorGain: 0.32,
  coreIceFirnCompactionBoost: 0.28,
  coreIceFreshDriftStart: 0.82,
  coreIceFreshDriftFull: 0.94,
  coreIceRidgeCrustPackedGain: 0.11,
  coreIceLeePowderAccumulationGain: 0.070,
  ridgeScourPackedGain: 0.32,
  windSlabPackedGain: 0.23,
  ridgeScourAccumulationSuppression: 0.50,
  shelteredPackedFloorGain: 0.14,
  packedGlacialPaletteFloorGain: 0.29,
  packedGlacialPaletteDepthGain: 0.12,
  packedGlacialPaletteShelterRetention: 0.70,
  accumulatedLeeGain: 0.76,
  accumulatedConcavityGain: 0.46,
  accumulatedGentleSlopeGain: 0.18,
  leeDriftAccumulationGain: 0.30,
  accumulatedPermanentIceScale: 0.50,
  accumulatedGlacialPaletteRetentionFloor: 0.70,
  shelteredGlacialRetentionFloor: 0.56,
  shelteredGlacialAccumulationCooling: 0.20,
  glacialDepthAccumulationCooling: 0.12,
  transitionAccumulationCoolingGain: 0.14,
  tundraToneScale: 0.78,
  minimumVisibleSnow: 0.08,
  minimumAccumulatedSnow: 0.22,
  maximumPackedWeight: 0.88,
  maximumAccumulatedWeight: 0.86,
  ridgeCrustPaletteGain: 0.22,
  ridgeCrustPowderSuppression: 0.16,
  leePowderPaletteGain: 0.24,
  leePowderPackedSuppression: 0.18,
