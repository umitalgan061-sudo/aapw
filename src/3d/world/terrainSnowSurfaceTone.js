...
export const TERRAIN_SNOW_SURFACE_TONE_POLICY = Object.freeze({
  id: 'terrain-snow-surface-tone-2026-09-02-v45-bounded-weathered-firn',
  renderOnly: true,
  ...
  glacialPowderAttenuation: 0.64,
  coreIcePowderAttenuation: 0.22,
  basePackedRetentionMin: 0.63,
  basePackedRetentionGlacialGain: 0.09,
  glacialVisibilityExponent: 0.65,
  glacialDepthFloor: 0.54,
  glacialDepthGain: 0.46,
  packedWindwardGain: 0.93,
  packedRidgeGain: 0.57,
  packedPermanentIceFloor: 0.045,
  packedGlacialContinuityGain: 0.045,
  packedGlacialFamilyGain: 0.16,
  packedGlacialDepthGain: 0.065,
  packedShelteredGlacialGain: 0.075,
  packedTransitionColdGain: 0.09,
  mixedIceFirnPackedFloorGain: 0.26,
  mixedIceFirnPowderAttenuation: 0.20,
  coreIceFirnPackedFloorGain: 0.27,
  coreIceFirnCompactionBoost: 0.15,
  coreIceFreshDriftStart: 0.83,
  coreIceFreshDriftFull: 0.945,
  coreIceRidgeCrustPackedGain: 0.19,
  coreIceLeePowderAccumulationGain: 0.11,
  ridgeScourPackedGain: 0.49,
  windSlabPackedGain: 0.37,
  ridgeScourAccumulationSuppression: 0.59,
  shelteredPackedFloorGain: 0.11,
  packedGlacialPaletteFloorGain: 0.25,
  packedGlacialPaletteDepthGain: 0.07,
  packedGlacialPaletteShelterRetention: 0.61,
  ...
  maximumPackedWeight: 0.89,
  maximumAccumulatedWeight: 0.92,
  ridgeCrustPaletteGain: 0.35,
  ridgeCrustPowderSuppression: 0.25,
  leePowderPaletteGain: 0.33,
  leePowderPackedSuppression: 0.25,
