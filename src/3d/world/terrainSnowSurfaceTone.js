...
export const TERRAIN_SNOW_SURFACE_TONE_POLICY = Object.freeze({
  id: 'terrain-snow-surface-tone-2026-09-02-v42-weathered-firn-contrast',
  renderOnly: true,
  ...
  glacialPowderAttenuation: 0.66,
  coreIcePowderAttenuation: 0.38,
  basePackedRetentionMin: 0.64,
  basePackedRetentionGlacialGain: 0.10,
  glacialVisibilityExponent: 0.65,
  glacialDepthFloor: 0.54,
  glacialDepthGain: 0.46,
  packedWindwardGain: 0.94,
  packedRidgeGain: 0.58,
  packedPermanentIceFloor: 0.05,
  packedGlacialContinuityGain: 0.05,
  packedGlacialFamilyGain: 0.17,
  packedGlacialDepthGain: 0.07,
  packedShelteredGlacialGain: 0.08,
  packedTransitionColdGain: 0.10,
  mixedIceFirnPackedFloorGain: 0.31,
  mixedIceFirnPowderAttenuation: 0.24,
  coreIceFirnPackedFloorGain: 0.36,
  coreIceFirnCompactionBoost: 0.18,
  coreIceFreshDriftStart: 0.84,
  coreIceFreshDriftFull: 0.95,
  coreIceRidgeCrustPackedGain: 0.22,
  coreIceLeePowderAccumulationGain: 0.08,
  ridgeScourPackedGain: 0.50,
  windSlabPackedGain: 0.38,
  ridgeScourAccumulationSuppression: 0.62,
  shelteredPackedFloorGain: 0.12,
  packedGlacialPaletteFloorGain: 0.29,
  packedGlacialPaletteDepthGain: 0.08,
  packedGlacialPaletteShelterRetention: 0.62,
  accumulatedLeeGain: 0.88,
  accumulatedConcavityGain: 0.60,
  accumulatedGentleSlopeGain: 0.22,
  leeDriftAccumulationGain: 0.40,
  accumulatedPermanentIceScale: 0.36,
  accumulatedGlacialPaletteRetentionFloor: 0.68,
  shelteredGlacialRetentionFloor: 0.66,
  shelteredGlacialAccumulationCooling: 0.11,
  glacialDepthAccumulationCooling: 0.07,
  transitionAccumulationCoolingGain: 0.09,
  tundraToneScale: 0.78,
  minimumVisibleSnow: 0.08,
  minimumAccumulatedSnow: 0.22,
  maximumPackedWeight: 0.92,
  maximumAccumulatedWeight: 0.90,
  ridgeCrustPaletteGain: 0.38,
  ridgeCrustPowderSuppression: 0.28,
  leePowderPaletteGain: 0.32,
  leePowderPackedSuppression: 0.24,
