...
float terrainPhotoWetPolish=terrainPhotoCoastalWet*0.085+terrainPhotoTideStain*0.095+terrainPhotoCoastalRockWet*0.055+terrainPhotoRunnel*0.10+terrainPhotoAlluvialWash*0.055+terrainPhotoWetSwaleDomain*0.050; float terrainPhotoRockPolish=terrainPhotoRockFace*terrainPhotoMoisture*0.045; float terrainPhotoSaltCrustRoughness=terrainPhotoSaltSpray*0.065; float terrainPhotoLowlandSoilCrust=terrainPhotoAerialLowland*((terrainPhotoMeso-0.5)*0.156+(terrainPhotoGrain-0.5)*0.060+terrainPhotoAerialHighPass*0.140); float terrainPhotoBroadDepositionalRoughness=terrainPhotoAerialLowland*(1.0-terrainPhotoCliff)*((terrainPhotoLandform-0.5)*0.205+(terrainPhotoAlluvialField-0.5)*0.156+(0.5-terrainPhotoDrainage)*terrainPhotoWetSwaleDomain*-0.105); float terrainPhotoLowlandDomainRoughness=terrainPhotoDryBenchDomain*(0.165+terrainPhotoGrain*0.078)+terrainPhotoMineralLagDomain*(0.190+terrainPhotoMeso*0.082)-terrainPhotoWetSwaleDomain*(0.095+(1.0-terrainPhotoDrainage)*0.055); float terrainPhotoGranularRoughness=terrainPhotoScreeBand*0.055+terrainPhotoSnowDeposit*0.025+terrainPhotoDryShoulder*0.045+terrainPhotoSaltCrustRoughness+terrainPhotoLowlandDomainRoughness+terrainPhotoLowlandSoilCrust+terrainPhotoBroadDepositionalRoughness; float terrainPhotoSnowRoughness=terrainPhotoSnow*((terrainPhotoSnowFine-0.5)*0.085+(terrainPhotoSnowSastrugi-0.5)*0.060); roughnessFactor=clamp(roughnessFactor-terrainPhotoWetPolish-terrainPhotoRockPolish+terrainPhotoGranularRoughness+terrainPhotoSnowRoughness,0.42,1.0);`);
		shader.fragmentShader = shader.fragmentShader.replace('#include <normal_fragment_maps>', `#include <normal_fragment_maps>
float terrainPhotoLowlandNormalStep=9.0; vec2 terrainPhotoLowlandFrameEast=terrainPhotoXZ+vec2(terrainPhotoLowlandNormalStep,0.0); vec2 terrainPhotoLowlandFrameWest=terrainPhotoXZ-vec2(terrainPhotoLowlandNormalStep,0.0); vec2 terrainPhotoLowlandFrameNorth=terrainPhotoXZ+vec2(0.0,terrainPhotoLowlandNormalStep); vec2 terrainPhotoLowlandFrameSouth=terrainPhotoXZ-vec2(0.0,terrainPhotoLowlandNormalStep); vec2 terrainPhotoLowlandBroadWarp=(vec2(terrainPhotoWarpA,terrainPhotoWarpB)-0.5)*220.0;
float terrainPhotoLowlandEast=terrainPhotoFbm(terrainPhotoLowlandFrameEast/54.0+vec2(23.8,3.6))*0.44+terrainPhotoRidgeNoise(vec2(terrainPhotoLowlandFrameEast.x/138.0+terrainPhotoLowlandFrameEast.y/410.0,terrainPhotoLowlandFrameEast.y/58.0-terrainPhotoLowlandFrameEast.x/530.0)+vec2(-6.2,14.1))*0.44+terrainPhotoNoise(terrainPhotoLowlandFrameEast/18.0+vec2(5.4,-18.2))*0.03+terrainPhotoRidgeNoise(vec2((terrainPhotoLowlandFrameEast.x+terrainPhotoLowlandBroadWarp.x)/300.0+(terrainPhotoLowlandFrameEast.y+terrainPhotoLowlandBroadWarp.y)/720.0,(terrainPhotoLowlandFrameEast.y+terrainPhotoLowlandBroadWarp.y)/220.0-(terrainPhotoLowlandFrameEast.x+terrainPhotoLowlandBroadWarp.x)/960.0)+vec2(12.7,-5.3))*0.70+terrainPhotoRidgeNoise(vec2((terrainPhotoLowlandFrameEast.x+terrainPhotoLowlandBroadWarp.x)/390.0+(terrainPhotoLowlandFrameEast.y+terrainPhotoLowlandBroadWarp.y)/980.0,(terrainPhotoLowlandFrameEast.y+terrainPhotoLowlandBroadWarp.y)/120.0-(terrainPhotoLowlandFrameEast.x+terrainPhotoLowlandBroadWarp.x)/760.0)+vec2(-18.4,9.6))*0.28;
float terrainPhotoLowlandWest=terrainPhotoFbm(terrainPhotoLowlandFrameWest/54.0+vec2(23.8,3.6))*0.44+terrainPhotoRidgeNoise(vec2(terrainPhotoLowlandFrameWest.x/138.0+terrainPhotoLowlandFrameWest.y/410.0,terrainPhotoLowlandFrameWest.y/58.0-terrainPhotoLowlandFrameWest.x/530.0)+vec2(-6.2,14.1))*0.44+terrainPhotoNoise(terrainPhotoLowlandFrameWest/18.0+vec2(5.4,-18.2))*0.03+terrainPhotoRidgeNoise(vec2((terrainPhotoLowlandFrameWest.x+terrainPhotoLowlandBroadWarp.x)/300.0+(terrainPhotoLowlandFrameWest.y+terrainPhotoLowlandBroadWarp.y)/720.0,(terrainPhotoLowlandFrameWest.y+terrainPhotoLowlandBroadWarp.y)/220.0-(terrainPhotoLowlandFrameWest.x+terrainPhotoLowlandBroadWarp.x)/960.0)+vec2(12.7,-5.3))*0.70+terrainPhotoRidgeNoise(vec2((terrainPhotoLowlandFrameWest.x+terrainPhotoLowlandBroadWarp.x)/390.0+(terrainPhotoLowlandFrameWest.y+terrainPhotoLowlandBroadWarp.y)/980.0,(terrainPhotoLowlandFrameWest.y+terrainPhotoLowlandBroadWarp.y)/120.0-(terrainPhotoLowlandFrameWest.x+terrainPhotoLowlandBroadWarp.x)/760.0)+vec2(-18.4,9.6))*0.28;
float terrainPhotoLowlandNorth=terrainPhotoFbm(terrainPhotoLowlandFrameNorth/54.0+vec2(23.8,3.6))*0.44+terrainPhotoRidgeNoise(vec2(terrainPhotoLowlandFrameNorth.x/138.0+terrainPhotoLowlandFrameNorth.y/410.0,terrainPhotoLowlandFrameNorth.y/58.0-terrainPhotoLowlandFrameNorth.x/530.0)+vec2(-6.2,14.1))*0.44+terrainPhotoNoise(terrainPhotoLowlandFrameNorth/18.0+vec2(5.4,-18.2))*0.03+terrainPhotoRidgeNoise(vec2((terrainPhotoLowlandFrameNorth.x+terrainPhotoLowlandBroadWarp.x)/300.0+(terrainPhotoLowlandFrameNorth.y+terrainPhotoLowlandBroadWarp.y)/720.0,(terrainPhotoLowlandFrameNorth.y+terrainPhotoLowlandBroadWarp.y)/220.0-(terrainPhotoLowlandFrameNorth.x+terrainPhotoLowlandBroadWarp.x)/960.0)+vec2(12.7,-5.3))*0.70+terrainPhotoRidgeNoise(vec2((terrainPhotoLowlandFrameNorth.x+terrainPhotoLowlandBroadWarp.x)/390.0+(terrainPhotoLowlandFrameNorth.y+terrainPhotoLowlandBroadWarp.y)/980.0,(terrainPhotoLowlandFrameNorth.y+terrainPhotoLowlandBroadWarp.y)/120.0-(terrainPhotoLowlandFrameNorth.x+terrainPhotoLowlandBroadWarp.x)/760.0)+vec2(-18.4,9.6))*0.28;
float terrainPhotoLowlandSouth=terrainPhotoFbm(terrainPhotoLowlandFrameSouth/54.0+vec2(23.8,3.6))*0.44+terrainPhotoRidgeNoise(vec2(terrainPhotoLowlandFrameSouth.x/138.0+terrainPhotoLowlandFrameSouth.y/410.0,terrainPhotoLowlandFrameSouth.y/58.0-terrainPhotoLowlandFrameSouth.x/530.0)+vec2(-6.2,14.1))*0.44+terrainPhotoNoise(terrainPhotoLowlandFrameSouth/18.0+vec2(5.4,-18.2))*0.03+terrainPhotoRidgeNoise(vec2((terrainPhotoLowlandFrameSouth.x+terrainPhotoLowlandBroadWarp.x)/300.0+(terrainPhotoLowlandFrameSouth.y+terrainPhotoLowlandBroadWarp.y)/720.0,(terrainPhotoLowlandFrameSouth.y+terrainPhotoLowlandBroadWarp.y)/220.0-(terrainPhotoLowlandFrameSouth.x+terrainPhotoLowlandBroadWarp.x)/960.0)+vec2(12.7,-5.3))*0.70+terrainPhotoRidgeNoise(vec2((terrainPhotoLowlandFrameSouth.x+terrainPhotoLowlandBroadWarp.x)/390.0+(terrainPhotoLowlandFrameSouth.y+terrainPhotoLowlandBroadWarp.y)/980.0,(terrainPhotoLowlandFrameSouth.y+terrainPhotoLowlandBroadWarp.y)/120.0-(terrainPhotoLowlandFrameSouth.x+terrainPhotoLowlandBroadWarp.x)/760.0)+vec2(-18.4,9.6))*0.28;
vec2 terrainPhotoLowlandGradient=vec2(terrainPhotoLowlandEast-terrainPhotoLowlandWest,terrainPhotoLowlandNorth-terrainPhotoLowlandSouth); float terrainPhotoLowlandNormalMask=terrainPhotoAerialLowland*clamp(0.58+terrainPhotoDryBenchDomain*0.68+terrainPhotoMineralLagDomain*0.84+terrainPhotoWetSwaleDomain*0.38+terrainPhotoPlainReach*0.24,0.0,1.0); vec3 terrainPhotoLowlandWorldPerturbation=vec3(-terrainPhotoLowlandGradient.x,0.0,-terrainPhotoLowlandGradient.y); normal=normalize(normal+mat3(viewMatrix)*terrainPhotoLowlandWorldPerturbation*terrainPhotoLowlandNormalMask*1.36);
