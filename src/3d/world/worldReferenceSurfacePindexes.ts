/** Production TypeScript owner for src/3d/world/worldReferenceSurfacePindexes.legacy.js. */
// @ts-nocheck
/**
...
export interface ReferenceSurfacePindexSample { readonly normalizedX:number; readonly normalizedY:number; readonly pindex:number }
