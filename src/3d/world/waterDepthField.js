...
const WATER_DEPTH_FIELD_OWNER_SPAN_METERS = Math.max(WORLD_SCALE.WORLD_WIDTH_METERS, WORLD_SCALE.WORLD_DEPTH_METERS);
export const WATER_DEPTH_FIELD_EXTENT_METERS = Math.ceil(WATER_DEPTH_FIELD_OWNER_SPAN_METERS * WATER_DEPTH_FIELD_RESOLUTION / (WATER_DEPTH_FIELD_RESOLUTION - 1));
export const WATER_DEPTH_FIELD_OWNER_GUARD_METERS = (WATER_DEPTH_FIELD_EXTENT_METERS - WATER_DEPTH_FIELD_OWNER_SPAN_METERS) / 2;
