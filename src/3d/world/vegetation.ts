/** Production TypeScript owner for src/3d/world/vegetation.legacy.js. */
// @ts-nocheck
/**
...
import { northClimateWeightsAtWorldZ } from './terrainBiomeShading.ts';
...
export interface VegetationPlacementContract { readonly x:number; readonly z:number; readonly speciesId:string }
