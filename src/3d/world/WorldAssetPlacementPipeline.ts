/** Production TypeScript owner for src/3d/world/WorldAssetPlacementPipeline.js. Legacy .js remains compatibility-only. */
// @ts-nocheck
...
export interface WorldAssetPlacementContract { readonly deterministic: boolean; readonly terrainMutation: false; readonly hydrologyMutation: false; readonly colliderMutation: false; }
