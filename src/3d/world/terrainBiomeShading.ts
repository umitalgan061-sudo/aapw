/** Production TypeScript owner for src/3d/world/terrainBiomeShading.legacy.js. */
// @ts-nocheck
/**
...
export interface TerrainBiomeSample { readonly worldX:number; readonly worldZ:number; readonly normalizedMapY:number }
