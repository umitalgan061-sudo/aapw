/** Production TypeScript owner for src/3d/world/chunkManager.js. Legacy .js remains compatibility-only. */
// @ts-nocheck
/**
...
import { createTerrainChunk, disposeTerrainChunk } from './terrain.ts';
...
export interface WorldStreamingStats { readonly residentChunks:number; readonly cumulativeChunks:number; readonly residentAreaKm2:number; readonly cumulativeAreaKm2:number }
