...
export const PROP_CATALOGUE_EXCLUSIONS = Object.freeze({
	/** Rigged, animated species — `gameplay/livingWorldSpawner.js` spawns and moves these. */
	riggedLivingEntity: 14,
	isItselfTerrain: 11,
	seatCastleModel: 32,
...
export const PROP_CATALOGUE = Object.freeze([
	...
	Object.freeze({ file: 'fbx/Modular Ruins Pack by Quaternius - F2LAK03B0r.glb', terrain: 'upland', footprintMeters: 7, weight: 2 }),
	...
	Object.freeze({ file: 'props/statue_athena_shield.glb', terrain: 'upland', footprintMeters: 7, weight: 2 }),
	Object.freeze({ file: 'props/statue_athena_spear.glb', terrain: 'upland', footprintMeters: 7, weight: 2 }),
	...
	Object.freeze({ file: 'settlements/greek_parthenon_base.glb', terrain: 'upland', footprintMeters: 7, weight: 2 }),
	Object.freeze({ file: 'settlements/greek_parthenon_roof.glb', terrain: 'upland', footprintMeters: 7, weight: 2 }),
	...
	// ---- upland ------------------------------------------------------------------------------
	Object.freeze({ file: 'fbx/Barracks by Quaternius - UXCOwRBSxx.glb', terrain: 'roadside', footprintMeters: 12, weight: 1 }),
	...
	Object.freeze({ file: 'fbx/Stone Wall Towers by Quaternius - geisKzlSFZ.glb', terrain: 'roadside', footprintMeters: 12, weight: 1 }),
	...
	// ---- static fauna, placed as ambient wildlife -----------------------------------------------
	// Reclassified in run 371. Run 370 excluded every animal model on the grounds that
	// `gameplay/livingWorldSpawner.js` owns living things — true of the *rigged* species, which walk,
	// flee and idle. But `assets_manifest.json` records 36 of the animal models as having no rig and no
	// animation clips at all, and the spawner cannot drive them: they were in no system whatsoever, so
	// "distribute all the models" left them nowhere. A motionless model placed in its own habitat is
	// what ambient fauna is in a low-poly world, and it is strictly better than an unused file.
	// Rigged species are still the spawner's and are still absent from this catalogue.
	...
	// ---- buildings misfiled under assets/models/animals/ ----------------------------------------
	// A cottage and two farms sit in the animals directory. Nothing looked for buildings there, so they
	// were unused; they are buildings and are catalogued as such.
