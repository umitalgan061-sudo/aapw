...
export const TERRAIN_ENVIRONMENT_ASSET_MANIFEST=freeze([
 ...
 freeze({src:'assets/models/fbx/rocky_terrain_low_poly.glb',family:'rock',geology:true,biomes:['forest','forest-edge','highland','tundra','alpine-bare','heath','meadow'],materialSurfaces:['rock','weathered-rock','moss-rock','snow'],season:'winter',preferred:true}),
 freeze({src:'assets/models/fbx/desert_rocks.glb',family:'rock',geology:true,biomes:['dryland','heath','meadow'],materialSurfaces:['rock','dry-rock','sandstone'],season:'dry',preferred:true}),
]);
