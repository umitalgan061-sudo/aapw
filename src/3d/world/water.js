...
const WATER_FRAGMENT_SHADER = /* glsl */ `
	...
	void main() {
		...
		float farMarineOpticalFloor = uFarLayerMask * farOpticalBlend * smoothstep(0.24, 0.92, rawOffshoreOptical) * ${WATER_SURFACE_VARIATION_POLICY.farMarineOpticalDepthFloor.toFixed(2)};
