/** Production TypeScript owner for src/3d/world/terrain.js. Legacy .js remains compatibility-only. */
// @ts-nocheck
/**
...
export interface TerrainHeightSampler { (worldX: number, worldZ: number): number }
export interface TerrainChunkOptions { readonly chunkX: number; readonly chunkZ: number; readonly size?: number; readonly segments?: number; readonly maxHeightMeters?: number; readonly seed?: number; readonly flattenPads?: readonly unknown[] }
