...
export interface WaterDepthFieldLike {
  readonly texture: THREE.Texture;
  readonly offshoreTexture?: THREE.Texture;
  readonly extentMeters: number;
}

export type WaterMesh = THREE.Mesh<THREE.PlaneGeometry, THREE.ShaderMaterial>;

export function createWater(waterLevelMeters: number, segments = WATER_PLANE_SEGMENTS): WaterMesh {
...
export function setWaterDepthField(waterMesh: WaterMesh, depthField: WaterDepthFieldLike, swellStrength = 1): void {
...
export function updateWater(waterMesh: WaterMesh, cameraPosition: THREE.Vector3, elapsedSeconds: number): void {
...
export function disposeWater(waterMesh: WaterMesh): void {
