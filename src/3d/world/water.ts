/** Production TypeScript owner for src/3d/world/water.js. Legacy .js remains compatibility-only. */
// @ts-nocheck
/**
...
/** Typed water runtime contract used by the frame loop and teardown path. */
export type WaterMesh = THREE.Mesh<THREE.BufferGeometry, THREE.Material | THREE.Material[]>;
export interface WaterUpdateContext {
