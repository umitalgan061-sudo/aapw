...
} from './WorldAssetPlacementPipeline.ts';
...
export interface SettlementPropPlacementContract { readonly deterministic: boolean; readonly maxSlopeDegrees: number; readonly minRoadDistanceMeters: number; }
