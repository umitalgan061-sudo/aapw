...
export const GEOGRAPHIC_REFERENCE_PALETTE_POLICY = Object.freeze({
	id: 'geographic-reference-palette-2026-09-14-v183-natural-distance-variation',
	renderOnly: true,
	deterministic: true,
	...
	fullWorldEcotoneDistanceGapPass3: true,	ridgelineAerialNeutralityPass4: true,
	...
	materialVariationProfile: Object.freeze({
		worldSpaceDeterministic: true,
		multiScaleBands: 4,
		fineBandWeight: 0.18,
		mesoBandWeight: 0.27,
		macroBandWeight: 0.55,
		roughnessRange: Object.freeze([0.72, 0.96]),
		normalStrengthRange: Object.freeze([0.22, 0.58]),
		avoidUniformSurface: true,
	}),
	...
	calibration: Object.freeze({
		terrain: 'v183 follows exact-head visual review of the latest full-world branch: keep canonical height, shoreline, hydrology and collider authority fixed while widening natural distance-readable separation between wet meadow, dry heath, ferric soil and weathered granite. The new profile records the intended world-space deterministic multi-scale material variation contract instead of flattening broad surfaces into one value.',
		water: 'v183 keeps the existing water palette and hydrology authority unchanged so terrain changes remain directly comparable.',
		road: 'v183 keeps route topology, width, terrain sampling and water exclusion unchanged; road wear remains owned by the road material stack.',
		celestial: 'v183 preserves dawn/noon/sunset/moon calibration and does not alter the day clock or lighting authority.',
	}),
});
...
export const GEOGRAPHIC_REFERENCE_PALETTE = Object.freeze({
	terrain: Object.freeze({
		...
		dryHeather: 0x76513e,
		wetEarth: 0x163a34,
		exposedEarth: 0xa06f52,
		graniteShadow: 0x425563,
		graniteSunlit: 0x8f877a,
		basaltWet: 0x203b47,
		quartz: 0xaaa9a2,
	}),
	road: Object.freeze({
