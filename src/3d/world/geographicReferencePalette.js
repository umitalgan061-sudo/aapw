...
export const GEOGRAPHIC_REFERENCE_PALETTE_POLICY = Object.freeze({
	id: 'geographic-reference-palette-2026-09-04-v133-weathered-distance-separation',
	renderOnly: true,
	deterministic: true,
	...
	calibration: Object.freeze({
		terrain: 'v133 keeps canonical geography untouched while separating cool meadow shadow, neutral weathered heath, mineral earth and granite/basalt midtones at aerial distance. The adjustment is deliberately modest so existing world-space normal/roughness breakup remains the primary relief cue instead of palette contrast becoming synthetic.',
		water: 'v133 slightly separates shore/lake/open-sea midtones from adjacent lowland values while preserving coverage, bathymetric authority, current/shear/foam/normal fabric and abyss depth.',
		road: 'v133 cools road wear hierarchy slightly so compacted earth, moist ruts, dust and embedded stone remain distinct without orange cast; route topology, width, terrain sampling and water exclusion are unchanged.',
		celestial: 'v133 preserves restrained dawn/noon/sunset/moon calibration and does not alter the day clock or lighting authority.',
	}),
});
...
export const GEOGRAPHIC_REFERENCE_PALETTE = Object.freeze({
	terrain: Object.freeze({
		...
		dryHeather: 0x696664,
		wetEarth: 0x163a32,
		exposedEarth: 0xaa967d,
		graniteShadow: 0x47545a,
		graniteSunlit: 0xc5c2ba,
		basaltWet: 0x315055,
		quartz: 0xdad6ce,
	}),
	road: Object.freeze({
