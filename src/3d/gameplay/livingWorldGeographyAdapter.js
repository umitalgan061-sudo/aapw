 ...
 * plausible and which already-tracked asset/surface family belongs to that context.
 */
...
import { WORLD_SCALE, WORLD_DEFAULTS } from '../config.js';
...
const REGION_ASSET_PROFILES = Object.freeze({
  snow: Object.freeze({
    human: Object.freeze({ family: 'guard-winter', assetCandidates: Object.freeze([
      'assets/models/characters/paladin_j_nordstrom.fbx',
      'assets/models/characters/uriel_a_plotexia.fbx',
    ]), surfaceRoles: Object.freeze(['skin','hair','eyes','clothing','boots','gear']),
    }),
    wildlife: Object.freeze({ species: Object.freeze(['wolf','bear','bighorn_sheep']),
      assetCandidates: Object.freeze(['assets/models/animals/wolf','assets/models/animals/bear_0PXWfxfb0Hu.glb','assets/models/animals/bighorn_sheep_4kUChlMv8Vp.glb']),
      habitat: Object.freeze({ minSlope: 34, waterAllowed: false, roadBuffer: 8, settlementBuffer: 120 }),
      surfaceRoles: Object.freeze(['fur','eye','claw','tooth']),
    }),
    scenery: Object.freeze(['snow-pine','dead-snow-tree','snow-rock']),
  }),
  north: Object.freeze({
    human: Object.freeze({ family: 'guard-boreal', assetCandidates: Object.freeze([
      'assets/models/characters/erika_archer.fbx',
      'assets/models/characters/dreyar.fbx',
    ]), surfaceRoles: Object.freeze(['skin','hair','eyes','clothing','boots','gear']),
    }),
    wildlife: Object.freeze({ species: Object.freeze(['wolf','deer','horse','bear']), assetCandidates: Object.freeze(['assets/models/animals/wolf','assets/models/animals/bear_0PXWfxfb0Hu.glb','assets/models/animals/white_horse_bEdE4rmZy9.glb']), habitat: Object.freeze({ minSlope: 32, waterAllowed: false, roadBuffer: 5, settlementBuffer: 110 }), surfaceRoles: Object.freeze(['fur','eye','claw','tooth']), }),
  ...
  marsh: Object.freeze({
    ...
    wildlife: Object.freeze({ species: Object.freeze(['wolf','boar','bird']), assetCandidates: Object.freeze(['assets/models/animals/wolf','assets/models/animals/bird_8Ph79kHbt9s.glb']), habitat: Object.freeze({ minSlope: 26, waterAllowed: true, maxWaterDepth: 0.12, roadBuffer: 4, settlementBuffer: 90 }), surfaceRoles: Object.freeze(['fur','eye','claw','tooth']) }),
  ...
  mountain: Object.freeze({
    ...
    wildlife: Object.freeze({ species: Object.freeze(['goat','sheep','eagle','bear']), assetCandidates: Object.freeze(['assets/models/animals/bighorn_sheep_4kUChlMv8Vp.glb','assets/models/animals/bear_0PXWfxfb0Hu.glb']), habitat: Object.freeze({ minSlope: 42, waterAllowed: false, roadBuffer: 6, settlementBuffer: 100 }), surfaceRoles: Object.freeze(['fur','eye','claw','tooth']) }),
  ...
  westerlands: Object.freeze({
    ...
    wildlife: Object.freeze({ species: Object.freeze(['deer','boar','horse','wolf']), assetCandidates: Object.freeze(['assets/models/animals/wolf','assets/models/animals/white_horse_bEdE4rmZy9.glb']), habitat: Object.freeze({ minSlope: 34, waterAllowed: false, roadBuffer: 5, settlementBuffer: 90 }), surfaceRoles: Object.freeze(['fur','eye','claw','tooth']) }),
  ...
  reach: Object.freeze({
    ...
    wildlife: Object.freeze({ species: Object.freeze(['horse','cow','sheep','deer','fox']), assetCandidates: Object.freeze(['assets/models/animals/white_horse_bEdE4rmZy9.glb','assets/models/animals/bighorn_sheep_4kUChlMv8Vp.glb']), habitat: Object.freeze({ minSlope: 30, waterAllowed: false, roadBuffer: 4, settlementBuffer: 75 }), surfaceRoles: Object.freeze(['fur','eye','claw','tooth']) }),
  ...
  desert: Object.freeze({
    ...
    wildlife: Object.freeze({ species: Object.freeze(['horse','camel','scorpion','snake']), assetCandidates: Object.freeze(['assets/models/animals/white_horse_bEdE4rmZy9.glb']), habitat: Object.freeze({ minSlope: 28, waterAllowed: false, roadBuffer: 3, settlementBuffer: 80 }), surfaceRoles: Object.freeze(['fur','eye','claw','tooth']) }),
  ...
  steppe: Object.freeze({
    ...
    wildlife: Object.freeze({ species: Object.freeze(['horse','bison','wolf','deer']), assetCandidates: Object.freeze(['assets/models/animals/white_horse_bEdE4rmZy9.glb','assets/models/animals/bison_by_poly_by_google_9strha_txds_na.glb','assets/models/animals/wolf']), habitat: Object.freeze({ minSlope: 32, waterAllowed: false, roadBuffer: 4, settlementBuffer: 90 }), surfaceRoles: Object.freeze(['fur','eye','claw','tooth']) }),
  ...
  arid: Object.freeze({
    ...
    wildlife: Object.freeze({ species: Object.freeze(['horse','goat','camel','scorpion']), assetCandidates: Object.freeze(['assets/models/animals/white_horse_bEdE4rmZy9.glb']), habitat: Object.freeze({ minSlope: 30, waterAllowed: false, roadBuffer: 3, settlementBuffer: 100 }), surfaceRoles: Object.freeze(['fur','eye','claw','tooth']) }),
  ...
  coast: Object.freeze({
    ...
    wildlife: Object.freeze({ species: Object.freeze(['horse','deer','bird','seal']), assetCandidates: Object.freeze(['assets/models/animals/white_horse_bEdE4rmZy9.glb','assets/models/animals/bird_8Ph79kHbt9s.glb']), habitat: Object.freeze({ minSlope: 26, waterAllowed: false, roadBuffer: 4, settlementBuffer: 85 }), surfaceRoles: Object.freeze(['fur','eye','claw','tooth']) }),
  ...
  jungle: Object.freeze({
    ...
    wildlife: Object.freeze({ species: Object.freeze(['jaguar','bird','monkey','snake']), assetCandidates: Object.freeze(['assets/models/animals/bird_8Ph79kHbt9s.glb']), habitat: Object.freeze({ minSlope: 30, waterAllowed: true, maxWaterDepth: 0.16, roadBuffer: 3, settlementBuffer: 80 }), surfaceRoles: Object.freeze(['fur','eye','claw','tooth']) }),
  ...
  valyria: Object.freeze({
    ...
    wildlife: Object.freeze({ species: Object.freeze(['dragon','ash-beast']), assetCandidates: Object.freeze(['assets/models/dragons']), habitat: Object.freeze({ minSlope: 40, waterAllowed: false, roadBuffer: 10, settlementBuffer: 140 }), surfaceRoles: Object.freeze(['scale','wing','eye','horn','claw']) }),
  ...
  temperate: Object.freeze({
    ...
    wildlife: Object.freeze({ species: Object.freeze(['horse','deer','wolf','boar']), assetCandidates: Object.freeze(['assets/models/animals/white_horse_bEdE4rmZy9.glb','assets/models/animals/wolf']), habitat: Object.freeze({ minSlope: 34, waterAllowed: false, roadBuffer: 4, settlementBuffer: 75 }), surfaceRoles: Object.freeze(['fur','eye','claw','tooth']) }),
...
function nearestDistance(point, entries) {
  ...
  for (const entry of Array.isArray(entries) ? entries : []) {
    ...
    nearest = Math.min(nearest, Math.hypot(point.x - entry.x, point.z - entry.z));
  }
  return nearest;
}

function roadDistance(point, roadEdges) {
  let nearest = Infinity;
  for (const edge of Array.isArray(roadEdges) ? roadEdges : []) {
    const points = Array.isArray(edge?.points) ? edge.points : [];
    for (let i = 1; i < points.length; i += 1) {
      const a = points[i - 1]; const b = points[i];
      const dx = finite(b?.x) - finite(a?.x); const dz = finite(b?.z) - finite(a?.z);
      const len2 = dx * dx + dz * dz || 1;
      const t = clamp(((point.x - finite(a?.x)) * dx + (point.z - finite(a?.z)) * dz) / len2, 0, 1);
      nearest = Math.min(nearest, Math.hypot(point.x - (finite(a?.x) + dx * t), point.z - (finite(a?.z) + dz * t)));
    }
  }
  return nearest;
}
...
export function resolveLivingWorldGeography({ worldX, worldZ, speciesId = null, role = 'guard', groundHeight = null, slopeDegrees = 0, waterDepth = 0, settlementDistance = Infinity, roadDistance = Infinity, seed = 0 } = {}) {
  ...
  const maxSlope = species?.maxSlope ?? profile.wildlife?.habitat?.minSlope ?? MAX_SLOPE;
...
export function resolveLivingWorldAssetProfile({ worldX, worldZ, speciesId = null, role = 'guard' } = {}) {
  ...
  if (role === 'wildlife') return Object.freeze({ ...profile.wildlife, region: geography.region, profileId: geography.region, geography });
  return Object.freeze({ ...profile.human, region: geography.region, profileId: geography.region, geography });
}
...
export function validateLivingWorldSpawn(context, { groundHeight, slopeDegrees, waterDepth, settlementSeats = [], roadEdges = [], role = 'wildlife', speciesId = null } = {}) {
  ...
  const settlementDistance = nearestDistance(point, settlementSeats);
  const roadDistanceMeters = roadDistance(point, roadEdges);
...
/**
 * Real asset handoff. Callers must have already loaded the authored model. The shared pipeline is the
 * only allowed world attachment gate; this adapter merely supplies the geography-derived metadata and
 * policy. No editor UI module is reachable from here.
 */
...
export function auditLivingWorldAsset(object, geography) {
  ...
  return Object.freeze({
    ...placement,
    geography: geography ? { region: geography.region, profileId: geography.profileId, normalizedReference: geography.normalizedReference } : null,
  });
}
...
export function livingWorldGeographyDigest(value) {
  const source = JSON.stringify({
    policyId: LIVING_WORLD_GEOGRAPHY_POLICY.id,
    region: value?.region,
...
export function auditLivingWorldGeographyCatalog() {
  ...
  return Object.freeze({ ok: errors.length === 0, errors: Object.freeze(errors), regionCount: Object.keys(REGION_ASSET_PROFILES).length });
}
