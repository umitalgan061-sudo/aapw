/** Production TypeScript owner for src/3d/gameplay/npc.js. Legacy .js remains compatibility-only. */
// @ts-nocheck
/**
...
export interface NpcRuntimeContract { readonly object3D: unknown; update(deltaSeconds:number, playerPosition?:unknown):void; dispose():void }
