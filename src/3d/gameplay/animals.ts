/** Production TypeScript owner for src/3d/gameplay/animals.js. Legacy .js remains compatibility-only. */
// @ts-nocheck
/**
...
/** Structural contract for a spawned wildlife entity. */
export interface WildlifeRuntimeEntity {
  readonly object3D: THREE.Object3D;
  update(deltaSeconds: number, playerPosition?: Readonly<{ x: number; z: number }>): void;
  dispose(): void;
}
