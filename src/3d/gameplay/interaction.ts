/** Production TypeScript owner for src/3d/gameplay/interaction.js. Legacy .js remains compatibility-only. */
// @ts-nocheck
/**
...
export interface InteractionControllerContract {
  handleChoice(index: number): void;
  handleKeyDown(event: Readonly<{code:string; repeat?:boolean}>): void;
  update(npcs: readonly { object3D: { position: { x:number; z:number } } }[], playerPosition: Readonly<{x:number;z:number}>): void;
}