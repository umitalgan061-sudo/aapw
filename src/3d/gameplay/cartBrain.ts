/** Production TypeScript owner for src/3d/gameplay/cartBrain.js. Legacy .js remains compatibility-only. */
// @ts-nocheck
/**
...
import { ROAD_COMFORT_GRADE_DEGREES } from '../world/roadPathfinder.ts';
...
export interface CartRuntimeContract {
  readonly object3D: unknown;
  update(deltaSeconds: number, playerPosition?: unknown): void;
  dispose(): void;
}
