/** Production TypeScript owner for src/3d/gameplay/livingWorldReactionIntegrationAdapter.js. Legacy .js remains compatibility-only. */
// @ts-nocheck
...
import { createLivingWorldReactionRuntime, LIVING_WORLD_REACTION_RUNTIME_POLICY } from './livingWorldReactionRuntime.ts';
