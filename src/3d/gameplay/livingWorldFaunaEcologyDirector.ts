/** Production TypeScript owner for src/3d/gameplay/livingWorldFaunaEcologyDirector.js. Legacy .js remains compatibility-only. */
// @ts-nocheck
/**
...
export interface FaunaEcologyDirectorContract { readonly version: string; readonly deterministic: boolean; readonly maxActorsPerTick: number; }
