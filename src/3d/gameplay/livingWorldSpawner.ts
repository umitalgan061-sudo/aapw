...
/** Typed orchestration result consumed by the production game loop. */
export interface LivingWorldSpawnResult {
  readonly npcs: readonly unknown[];
  readonly animals: readonly unknown[];
  readonly creatures: readonly unknown[];
  readonly carts: readonly unknown[];
  readonly dragons: readonly unknown[];
}
