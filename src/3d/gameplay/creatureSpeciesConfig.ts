/**
 * TypeScript production owner for the former creatureSpeciesConfig.js module.
 ...
 *
 * @module gameplay/creatureSpeciesConfig.ts
 */
...
export type CreatureSpeciesRegistry = typeof CREATURE_SPECIES;
