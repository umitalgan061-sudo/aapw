...
const WORLD_EVENTS = Object.freeze([
	...
	// Run 371 batch — 20 new ambient events, expanding the FAZ 8 catalog (57 → 77).
	...
	{ id: 'duel_challenge', icon: '🤺', title: 'Düello Daveti', desc: 'İki soylu genç kale avlusunun ortasında birbirine eldiven fırlattı — onur meselesi derler, ama kimse gerçek nedeni söylemiyor.', color: '#8a3a3a', weight: WEIGHT.UNCOMMON, timeOfDay: 'day' },
	{ id: 'counterfeit_coin', icon: '🪙', title: 'Sahte Sikke', desc: 'Pazarda bir tüccar aldığı gümüş sikkeyi ışığa tutup kaşlarını çattı — kenarı hafifçe pürüzlü, ağırlığı biraz eksik.', color: '#9a8a4a', weight: WEIGHT.UNCOMMON, timeOfDay: 'day' },
	...
	{ id: 'masked_ball', icon: '🎉', title: 'Maskeli Balo', desc: 'Kale büyük salonunda maskeli bir balo düzenleniyor; kimliğini gizleyen misafirler arasında kimin kim olduğunu kestirmek güçleşiyor.', color: '#a85ac0', weight: WEIGHT.UNCOMMON, timeOfDay: 'night' },
	...
	{ id: 'well_run_dry', icon: '💧', title: 'Kuyu Kuruması', desc: 'Köyün eski kuyusu bu sabah kuru çıktı; yaşlılar bunu geçen kışın kuraklığına, gençler ise başka bir şeye yoruyor.', color: '#7a8a9a', weight: WEIGHT.UNCOMMON, timeOfDay: 'day' },
	{ id: 'wine_shipment', icon: '🍷', title: 'Şarap Sevkiyatı', desc: 'Güneyden gelen fıçı dolusu şarap kale mahzenine indiriliyor; taşıyıcıların yorgun yüzünde uzun bir yolculuğun izleri var.', color: '#7a2a3a', weight: WEIGHT.COMMON, timeOfDay: 'day' },
	...
	{ id: 'thief_caught', icon: '✋', title: 'Hırsız Yakalandı', desc: 'Pazar yerinde bir cep hırsızı suçüstü yakalandı; kalabalık etrafını sararken nöbetçiler onu güçlükle çekip çıkardı.', color: '#8a7a3a', weight: WEIGHT.COMMON, timeOfDay: 'day' },
	{ id: 'new_moon_rite', icon: '🌘', title: 'Yeni Ay Ayini', desc: 'Eski tanrılara inananlar yeni ayın karanlığında sessiz bir ayin için ormana doğru yürüyor; hiçbiri geri dönene kadar tek kelime etmeyecek.', color: '#2a2a3a', weight: WEIGHT.RARE, timeOfDay: 'night' },
	...
	{ id: 'blood_moon', icon: '🔴', title: 'Kızıl Ay', desc: 'Ay bu gece kan kırmızısına bürünmüş — bazı yaşlılar bunu sıradan bir gölge oyunu, bazıları bir uyarı sayıyor.', color: '#8a1a1a', weight: WEIGHT.RARE, timeOfDay: 'night' },
	{ id: 'merchant_scandal', icon: '💰', title: 'Tüccar Skandalı', desc: 'Zengin bir tüccarın tartıda hile yaptığı ortaya çıktı; malları pazardan toplatılırken adı bir süre daha ağızdan ağıza dolaşacak.', color: '#9a7a2a', weight: WEIGHT.UNCOMMON, timeOfDay: 'day' },
