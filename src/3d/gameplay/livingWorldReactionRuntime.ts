/** Production TypeScript owner for src/3d/gameplay/livingWorldReactionRuntime.js. Legacy .js remains compatibility-only. */
// @ts-nocheck
/**
...
export interface LivingWorldReactionRuntimeContract { readonly deterministic: boolean; readonly bounded: boolean; readonly replaySafe: boolean; }
