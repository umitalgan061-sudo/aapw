/** Production TypeScript owner for game-loop helpers; legacy JS path remains compatibility-only. */
// @ts-nocheck
/**
...
import { worldToChunkCoord } from './sceneManager.ts';
...
/** Stable typed contract for the lock-on evaluation path. */
export interface PlayerLockCandidateResult {
