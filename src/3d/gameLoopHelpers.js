...
/**
 * Keeps gameplay camera-agnostic while carrying non-spatial held actions on the same already-
 * existing per-frame input object. `guarding` never changes vector normalization.
 */
...
/** Keyboard + touch share movement/run/guard semantics; jump remains edge-triggered separately. */
