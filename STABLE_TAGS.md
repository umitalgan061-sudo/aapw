...
- stable-2026-08-09-0043 — run 200 opt-in canonical developer startup; real HTML boot + canonical activate/rollback/reactivate + SW-controlled warm-cache offline reload + full smoke/console/PWA/mobile/perf/governance PASS; default runtime unchanged.
