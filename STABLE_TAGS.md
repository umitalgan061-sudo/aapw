...
stable-2026-08-11-0914 — Run253 editor unknown-only scene load regression; unknown-only valid scene stays empty while serialized metadata restores safely; PWA/perf/determinism/smoke gates verified.
