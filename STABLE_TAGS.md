...
- `stable-2026-08-08-1131` — run 179 canonical-map coastline/water-mask contract (ADR-0200); 34/34+ browser smoke, map/mask checksum, terrain/road, PWA/mobile/perf/governance gates PASS; runtime render delta 0.

- stable-2026-08-08-1131 — run 179 canonical-map coastline/water-mask contract (ADR-0200); 34/34+ browser smoke and governance gates PASS.
