...
- `stable-2026-08-12-run306-fbx-pack` — Run306 node-safe independent FBX pack transforms: focused Chromium, legacy Node/materializer, PWA/cache, mobile perf/world-safety, determinism, governance and full smoke PASS; additive-only source delta +463/-0.
