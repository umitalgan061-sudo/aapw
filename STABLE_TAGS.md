...
- `stable-2026-08-12-run302-fbx-pack` — Run302 independent FBX child/pack transforms: focused Chromium proof, PWA/cache, mobile perf/world-safety, determinism, governance and full browser smoke PASS; additive-only source delta +414/-0.
