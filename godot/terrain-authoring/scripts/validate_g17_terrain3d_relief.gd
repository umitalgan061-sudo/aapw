...
const EXPECTED_SCHEMA := "westeros-g17-relief-v1"
...
func _fail(message: String) -> void:
	push_error("G17 Terrain3D relief failed: " + message)
	quit(1)
...
func _run() -> void:
	...
	terrain.name = "G17Terrain3DRelief"
	...
	var save_dir := "user://g17-terrain3d-relief-" + suffix
