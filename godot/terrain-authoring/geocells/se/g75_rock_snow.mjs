...
export function sampleG75RockSnow(nx, ny) {
  ...
  // Rock exposure is a broad physical field: relief/slope drives exposure while
  // canonical mountain/rocky/arid biome influence biases the material family.
  // No GeoCell/Pindex/grid edge participates in this value.
  ...
  // Snow is deliberately conservative in this SE parcel. Elevation alone never
  // creates snow: a canonical cold-climate signal is also required. This avoids
  // painting arbitrary white patches merely because the layer is named Rock/Snow.
