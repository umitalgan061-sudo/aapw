...
export const G77_ROCK_SNOW_POLICY = Object.freeze({
  id: 'kizil-ufuk-g77-terrain3d-rock-snow-2026-08-14-v1',
...
export function sampleG77RockSnow(nx, ny) {
  ...
  const landFactor = 1 - smoothstep(0.40, 0.60, water);
  ...
  const coastExposure = smoothstep(0.30, 0.58, water) * landFactor;
