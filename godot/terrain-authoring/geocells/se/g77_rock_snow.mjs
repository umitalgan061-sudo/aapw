...
export const G77_ROCK_SNOW_POLICY = Object.freeze({
  id: 'kizil-ufuk-g77-terrain3d-rock-snow-2026-08-14-v2',
...
export function sampleG77RockSnow(nx, ny) {
  ...
  // Canonical water ownership starts at 0.5. Fade rock/snow fully to zero by that exact
  // semantic boundary so continuous coastal transition never leaks material onto water.
  const landFactor = 1 - smoothstep(0.40, 0.50, water);
  ...
  const coastExposure = smoothstep(0.30, 0.48, water) * landFactor;
