...
export function measureG07RoadPath(runtimeNetwork) {
  ...
  // Because G07 is open sea, the physically correct field is identically zero.
  // These metrics remain explicit so a later accidental edge/grid paint cannot pass.
