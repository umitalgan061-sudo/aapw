...
// Global open-water substrate convention. The shallow/deep interpolation is driven only by the
// canonical owner-map coast field, so it remains independent of GeoCell partitioning. G70 is
// unambiguous open sea, therefore its current core and proven west/south guards resolve to the
// deep-water endpoint without inventing spatial variation that map.png does not encode.
