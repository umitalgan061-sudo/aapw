 ...
 * staircase coastline. This authoring/QA module derives a continuous water-confidence
 * field from the immutable mask without changing any cell-centre semantic classification.
 *
 * It is intentionally NOT shipped under src/3d in this first NW unit: no terrain height,
 * collider, settlement, road, production material, service-worker graph or runtime module
 * is mutated. A later integration unit may consume this field only after visual evidence
 * proves a measurable map-fidelity improvement.
 */
